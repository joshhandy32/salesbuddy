...
- BDR tooling added beyond the roadmap: Call Blitz (live dial-session tracker that
  feeds pacing) and Playbook (objection / opener / voicemail / email snippet library).
